...
<title>Admin: View Parking Spots</title>
...
<a href ="edit_PS.jsp?id=<%=p.getId()%>" class="btn btn-sm bg-success text-white">Edit</a>
<a href="delete?id=<%=p.getId()%>" class="btn btn-sm bg-danger text-white">Delete</a>
</div>
</div>
</div>
  <%}
